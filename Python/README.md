EstractorFile: Script in Python che, dato un path iniziale, sposta tutti i file con una determinata estensione all'interno delle cartelle, nel path iniziale.
